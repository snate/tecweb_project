...
\include{sections/requisiti} % 100%

\include{sections/struttura} % 100%

\include{sections/presentazione} % IN PROGRESS

\include{sections/comportamento} % 90%

\include{sections/dati} % 100%

\include{sections/accessibilita} % 80%

\include{sections/validazione} % 80%
